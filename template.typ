...
#let template(
  doc,
  head: (name: "主标题", value: none, visible: none, depth: none),
  title: (name: "标题", value: none, visible: none, depth: none),
  title_en: (name: "英文标题", value: none, visible: none, depth: none),
  school_semester: (name: "学期信息", value: none, visible: none, depth: none),
  school: (name: "学校", value: none, visible: none, depth: none),
  course_id: (name: "课程号", value: none, visible: none, depth: none),
  course_name: (name: "课程名称", value: none, visible: none, depth: none),
  college: (name: "学院", value: none, visible: none, depth: none),
  author: (name: "学生姓名", value: none, visible: none, depth: none),
  student_id: (name: "学号", value: none, visible: none, depth: none),
  class: (name: "班级", value: none, visible: none, depth: none),
  major: (name: "专业", value: none, visible: none, depth: none),
  supervisor: (name: "指导教师", value: none, visible: none, depth: none),
  date: (name: "日期", value: datetime.today().display("[year]年[month]月[day]日"), visible: none, depth: none),
  info_order: none,
) = {
  // 1. 页面设置
  set page(
